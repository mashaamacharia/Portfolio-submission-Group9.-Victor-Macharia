...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'vickienesh0705@gmail.com';  // Replace with your Gmail address
        $mail->Password = '@Family0705';  // Replace with your Gmail password (or use OAuth for better security)
